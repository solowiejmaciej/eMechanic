      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative isolate">
            {/* Decorative Elements - Fade in after card animation */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              <div className="absolute -top-20 -right-20 w-48 h-48 bg-secondary/20 dark:bg-secondary/40 rounded-full blur-3xl" />
              <div className="absolute -bottom-20 -left-20 w-48 h-48 bg-primary/20 dark:bg-primary/40 rounded-full blur-3xl" />
            </motion.div>
            ...
            >
              <div className="bg-white dark:bg-dark-card rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 p-4 rotate-2 hover:rotate-0 transition-transform duration-500 relative">
                {/* Mockup Header */}
