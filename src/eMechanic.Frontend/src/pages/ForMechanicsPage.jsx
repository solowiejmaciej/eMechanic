...
const ForMechanicsPage = () => {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-dark-lighter transition-colors">
      ...
      {/* Hero */}
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-dark text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <motion.button
            ...
            className="px-8 py-4 bg-secondary hover:bg-secondary-hover text-white font-bold rounded-full text-lg shadow-lg shadow-secondary/25 transition-all"
          >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="p-8 bg-white dark:bg-dark-card rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm">
