...
public class RegisterWorkshopFeatureTests : IClassFixture<IntegrationTestWebAppFactory>
{
    ...
    private RegisterWorkshopCommand CreateValidCommand() => new(
    ...
    public RegisterWorkshopFeatureTests(IntegrationTestWebAppFactory factory)
    {
        _client = factory.CreateClient();
    }

    [Fact]
    public async Task RegisterWorkshop_Should_ReturnCreated_WhenDataIsValid()
    {
        var command = CreateValidCommand();
        var response = await _client.PostAsJsonAsync("/api/v1/workshops/register", command);
    ...
    [Fact]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenEmailIsNotUnique()
    {
        var uniqueEmail = $"duplicate-login-{Guid.NewGuid()}@workshop.com";
        var command1 = CreateValidCommand() with { Email = uniqueEmail };
        var response1 = await _client.PostAsJsonAsync("/api/v1/workshops/register", command1);
        response1.EnsureSuccessStatusCode();

        var command2 = CreateValidCommand() with { Email = uniqueEmail };
        var response2 = await _client.PostAsJsonAsync("/api/v1/workshops/register", command2);
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenLoginEmailIsEmpty(string? invalidEmail)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenPasswordIsEmpty(string? invalidPassword)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenContactEmailIsEmpty(string? invalidContactEmail)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenNameIsEmpty(string? invalidName)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenDisplayNameIsEmpty(string? invalidDisplayName)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenPhoneNumberIsEmpty(string? invalidPhone)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenAddressIsEmpty(string? invalidAddress)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenCityIsEmpty(string? invalidCity)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenPostalCodeIsEmpty(string? invalidPostalCode)
    {
    ...
    [InlineData("   ")]
    [InlineData(null)]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenCountryIsEmpty(string? invalidCountry)
    {
    ...
    [InlineData("DSA")]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenEmailFormatIsInvalid(string invalidEmail)
    {
        var command = CreateValidCommand() with { Email = invalidEmail };
        var response = await _client.PostAsJsonAsync("/api/v1/workshops/register", command);
    ...
    [InlineData("kontaktdasdadasdas.pl")]
    [InlineData("DSA")]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenContactEmailFormatIsInvalid(string invalidContactEmail)
    {
        var command = CreateValidCommand() with { ContactEmail = invalidContactEmail };
        var response = await _client.PostAsJsonAsync("/api/v1/workshops/register", command);
    ...
    [Fact]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenPasswordIsTooShort()
    {
    ...
    [Fact]
    public async Task RegisterWorkshop_Should_ReturnBadRequest_WhenPasswordMissesDigit()
    {
