...
public class RepairCreatedEventHandler : IDomainEventHandler<RepairCreatedDomainEvent>
{
    private readonly IUserRepository _userRepository;
    private readonly IVehicleRepository _vehicleRepository;
    private readonly IOutboxWriter _outboxWriter;

    public RepairCreatedEventHandler(
    ...
    public async Task Handle(RepairCreatedDomainEvent notification, CancellationToken cancellationToken)
    {
        ...
        var integrationEvent = new RepairCreatedEvent(
            repair.Id,
