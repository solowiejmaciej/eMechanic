...
public class RepairPaidEventHandler : IDomainEventHandler<RepairPaidDomainEvent>
{
    private readonly IUserRepository _userRepository;
    private readonly IVehicleRepository _vehicleRepository;
    private readonly IOutboxWriter _outboxWriter;

    public RepairPaidEventHandler(
    ...
    public async Task Handle(RepairPaidDomainEvent notification, CancellationToken cancellationToken)
    {
        ...
        var integrationEvent = new RepairPaidEvent(
            repair.Id,
