...
public class RepairRequestRejectedEventHandler : IDomainEventHandler<RepairRequestRejectedDomainEvent>
{
    ...
    public RepairRequestRejectedEventHandler(
    ...
    public async Task Handle(RepairRequestRejectedDomainEvent notification, CancellationToken cancellationToken)
    {
        ...
        if (user is null || vehicle is null || repairRequest.RejectionReason is null)
        {
            return;
        }
